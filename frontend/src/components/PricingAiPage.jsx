  ...
  if (analysisData?.run_id === 'ingest_only') {
    return (
      <div style={{ padding: '40px', textAlign: 'center', background: 'white', borderRadius: '8px' }}>
        <Tag size={48} color="#059669" style={{ marginBottom: '16px' }} />
        ...
        <p style={{ color: '#64748b' }}>To view Pricing AI recommendations, please upload a <b>Retail Data</b> file with store products and inventory.</p>
        <button
